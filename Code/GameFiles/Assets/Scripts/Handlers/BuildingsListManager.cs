...
public class BuildingsListManager : MonoBehaviour
{
    ...
    void SetBuildings()
    {
        Buildings = new Building[]
        {
            ...
            false,100,300,true,3,100,80,false,0,false,false,20,23,20,10),
            new Building("Town Hall",800,-4, "The core building for your city",new int[3,3]{{1,1,1},{ 1, 1, 1 }, { 0,1,1}},new int[] { 2,0 },
            false,50,250,false,4,50,30,false,0,false, false,15,10,15,10),
            ...
            false,100,300,false,6,0,20,false,0,false,false,2,0,5,10,400,10),
            ...
            ,100,300,false,7,100,150,true,40,false,false,30,20,50,20),
            new Building("Train Station",1000,20,"a stop for trains",new int[2,2]{{1,1},{0,1} } ,new int[]{1,0},false,
            50,150,false,8,100,20,false,0,true,false,30,10,40,10),
